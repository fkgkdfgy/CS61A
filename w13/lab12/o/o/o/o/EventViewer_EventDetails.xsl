...
<xsl:variable name="FontFamily">Microsoft YaHei UI</xsl:variable>
<xsl:variable name="FontFamily_FixWidth">Microsoft YaHei UI</xsl:variable>
<xsl:variable name="FontSize">11</xsl:variable>
<xsl:variable name="FontStyle">font-family: 'Microsoft YaHei UI';</xsl:variable>
...
<xsl:variable name="WordsFormat">以字为单位</xsl:variable>

<!-- _locID_text="BytesFormat" -->
<xsl:variable name="BytesFormat">以字节为单位</xsl:variable>
...
<xsl:when test="descendant::*[contains(local-name(), 'Binary')]">
  ...
  <xsl:variable name="BinaryDataCaption">二进制数据:</xsl:variable>
